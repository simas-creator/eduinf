...
const ViewCard = () => {
  return (
    ...
    <Link href="/perziureti-ivertinimus">
      <div className="w-[300px] h-full">
        <div className="group lg:h-80 relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:rounded-lg">
          ...
          <div className="relative z-10 mx-auto w-full">
            <span className="grid h-20 w-20 place-items-center rounded-full bg-accent transition-all duration-300 group-hover:bg-secondary">
              <svg
            ...
            <div className="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
              <p>
                Pasirinkite norimą mokyklą ar universitetą ir peržiūrėkite visus dėstytojus bei mokytojus.
              </p>
            </div>
            <div className="pt-5 lg:pt-10 text-base font-semibold leading-7">
              <p className="text-accent transition-all duration-300 group-hover:text-white lg:text-lg">
